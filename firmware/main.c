...
//SPECIAL MODIFICATION FOR BSIDES BADGE
#ifndef CONFIG_HAVE__BOOTLOADER_IGNOREPROGBUTTON
	#define CONFIG_HAVE__BOOTLOADER_IGNOREPROGBUTTON
#endif

#ifndef CONFIG_HAVE__BOOTLOADER_ALWAYSENTERPROGRAMMODE
	#define CONFIG_HAVE__BOOTLOADER_ALWAYSENTERPROGRAMMODE
#endif
