...
00007488 l       .text	00000000 _mywait_sleeploop228
...
haveTwoBitsK:
    ...
    andi    x1, USBMASK     ;[12]
    71aa:	04 78       	andi	r16, 0x84	; 132
    bst     x1, USBMINUS    ;[13]
    71ac:	07 fb       	bst	r16, 7
    bld     shift, 7        ;[14]
...
usbSendAndReti:             ; 12 cycles until SOP
    ...
    ori     x2, USBMASK     ;[-11]
    730c:	14 68       	ori	r17, 0x84	; 132
    sbi     USBOUT, USBMINUS;[-10] prepare idle state; D+ and D- must have been 0 (no pullups)
    730e:	5f 9a       	sbi	0x0b, 7	; 11
...
;end of usbDeviceAddress transfer
    ...
    ori     x1, USBIDLE     ;[4]
    736a:	00 68       	ori	r16, 0x80	; 128
    in      x2, USBDDR      ;[5]
    736c:	1a b1       	in	r17, 0x0a	; 10
    cbr     x2, USBMASK     ;[6] set both pins to input
    736e:	1b 77       	andi	r17, 0x7B	; 123
    mov     x3, x1          ;[7]
    7370:	40 2f       	mov	r20, r16
    cbr     x3, USBMASK     ;[8] configure no pullup on both pins
    7372:	4b 77       	andi	r20, 0x7B	; 123
    ldi     x4, 4           ;[9]
...
00007488 <_mywait_sleeploop228>:
    7488:	a8 95       	wdr
    748a:	31 97       	sbiw	r30, 0x01	; 1
    748c:	80 40       	sbci	r24, 0x00	; 0
    748e:	e1 f7       	brne	.-8      	; 0x7488 <_mywait_sleeploop228>
{
    usbInit();
    /* enforce USB re-enumerate: */
    usbDeviceDisconnect();  /* do this while interrupts are disabled */
...
uchar   i;
    ...
    749c:	46 c1       	rjmp	.+652    	; 0x772a <_mywait_sleeploop228+0x2a2>
 ...
 */
    ...
    74b4:	09 f0       	breq	.+2      	; 0x74b8 <_mywait_sleeploop228+0x30>
    74b6:	b9 c0       	rjmp	.+370    	; 0x762a <_mywait_sleeploop228+0x1a2>
        if(len != 8)    /* Setup size must be always 8 bytes. Ignore otherwise. */
    74b8:	88 30       	cpi	r24, 0x08	; 8
    74ba:	09 f0       	breq	.+2      	; 0x74be <_mywait_sleeploop228+0x36>
    74bc:	34 c1       	rjmp	.+616    	; 0x7726 <_mywait_sleeploop228+0x29e>
            return;
    ...
    74d8:	b9 f1       	breq	.+110    	; 0x7548 <_mywait_sleeploop228+0xc0>
{
...
static uchar    replyBuffer[4];
    ...
    74e8:	31 f4       	brne	.+12     	; 0x74f6 <_mywait_sleeploop228+0x6e>
    ...
    74f2:	24 e0       	ldi	r18, 0x04	; 4
        len = (usbMsgLen_t)4;
    74f4:	90 c0       	rjmp	.+288    	; 0x7616 <_mywait_sleeploop228+0x18e>
    74f6:	35 30       	cpi	r19, 0x05	; 5
    }else if((rq->bRequest == USBASP_FUNC_ENABLEPROG) || (rq->bRequest == USBASP_FUNC_SETISPSCK)){
    74f8:	19 f1       	breq	.+70     	; 0x7540 <_mywait_sleeploop228+0xb8>
    74fa:	3a 30       	cpi	r19, 0x0A	; 10
    74fc:	09 f1       	breq	.+66     	; 0x7540 <_mywait_sleeploop228+0xb8>
    ...
    7504:	98 f4       	brcc	.+38     	; 0x752c <_mywait_sleeploop228+0xa4>
    ...
    7514:	b9 f0       	breq	.+46     	; 0x7544 <_mywait_sleeploop228+0xbc>
    ...
    752a:	6f c0       	rjmp	.+222    	; 0x760a <_mywait_sleeploop228+0x182>
...
#	else
    ...
    7532:	11 f4       	brne	.+4      	; 0x7538 <_mywait_sleeploop228+0xb0>
...
#	else
      stayinloader	   &= (0xfe);
    7536:	01 c0       	rjmp	.+2      	; 0x753a <_mywait_sleeploop228+0xb2>
...
#	endif
    ...
    753e:	02 c0       	rjmp	.+4      	; 0x7544 <_mywait_sleeploop228+0xbc>
    ...
    if(rq->bRequest == USBASP_FUNC_TRANSMIT){   /* emulate parts of ISP protocol */
        ...
        /* replyBuffer[0] = 0; is never touched and thus always 0 which means success */
        len = (usbMsgLen_t)1;
    7542:	69 c0       	rjmp	.+210    	; 0x7616 <_mywait_sleeploop228+0x18e>
...
usbRequest_t    *rq = (void *)data;
usbMsgLen_t     len = 0;
    7546:	67 c0       	rjmp	.+206    	; 0x7616 <_mywait_sleeploop228+0x18e>
...
uchar   index = rq->wIndex.bytes[0];
    ...
    7550:	06 c0       	rjmp	.+12     	; 0x755e <_mywait_sleeploop228+0xd6>
...
uchar   *dataPtr = usbTxBuf + 9;    /* there are 2 bytes free space at the end of the buffer */
    ...
    755a:	22 e0       	ldi	r18, 0x02	; 2
        ...
        dataPtr[1] = 0;
        len = 2;
    755c:	50 c0       	rjmp	.+160    	; 0x75fe <_mywait_sleeploop228+0x176>
    ...
    7560:	19 f4       	brne	.+6      	; 0x7568 <_mywait_sleeploop228+0xe0>
    7562:	80 93 24 01 	sts	0x0124, r24
        usbNewDeviceAddr = value;
    7566:	3d c0       	rjmp	.+122    	; 0x75e2 <_mywait_sleeploop228+0x15a>
    7568:	36 30       	cpi	r19, 0x06	; 6
        USB_SET_ADDRESS_HOOK();
    SWITCH_CASE(USBRQ_GET_DESCRIPTOR)       /* 6 */
    756a:	a9 f5       	brne	.+106    	; 0x75d6 <_mywait_sleeploop228+0x14e>
...
uchar       flags = USB_FLG_MSGPTR_IS_ROM;
    ...
    7570:	19 f4       	brne	.+6      	; 0x7578 <_mywait_sleeploop228+0xf0>
    7572:	88 e9       	ldi	r24, 0x98	; 152
        GET_DESCRIPTOR(USB_CFG_DESCR_PROPS_DEVICE, usbDescriptorDevice)
    7574:	90 e7       	ldi	r25, 0x70	; 112
    7576:	04 c0       	rjmp	.+8      	; 0x7580 <_mywait_sleeploop228+0xf8>
    7578:	92 30       	cpi	r25, 0x02	; 2
    SWITCH_CASE(USBDESCR_CONFIG)    /* 2 */
    757a:	41 f4       	brne	.+16     	; 0x758c <_mywait_sleeploop228+0x104>
    ...
    758a:	21 c0       	rjmp	.+66     	; 0x75ce <_mywait_sleeploop228+0x146>
    758c:	93 30       	cpi	r25, 0x03	; 3
    SWITCH_CASE(USBDESCR_STRING)    /* 3 */
    758e:	f1 f4       	brne	.+60     	; 0x75cc <_mywait_sleeploop228+0x144>
    7590:	81 11       	cpse	r24, r1
        ...
        SWITCH_CASE(0)
    7592:	08 c0       	rjmp	.+16     	; 0x75a4 <_mywait_sleeploop228+0x11c>
    ...
    75a2:	15 c0       	rjmp	.+42     	; 0x75ce <_mywait_sleeploop228+0x146>
    75a4:	81 30       	cpi	r24, 0x01	; 1
        SWITCH_CASE(1)
    75a6:	41 f4       	brne	.+16     	; 0x75b8 <_mywait_sleeploop228+0x130>
    ...
    75b6:	0b c0       	rjmp	.+22     	; 0x75ce <_mywait_sleeploop228+0x146>
    75b8:	82 30       	cpi	r24, 0x02	; 2
        SWITCH_CASE(2)
    75ba:	41 f4       	brne	.+16     	; 0x75cc <_mywait_sleeploop228+0x144>
    ...
    75ca:	01 c0       	rjmp	.+2      	; 0x75ce <_mywait_sleeploop228+0x146>
...
usbMsgLen_t len = 0;
    ...
    75d4:	18 c0       	rjmp	.+48     	; 0x7606 <_mywait_sleeploop228+0x17e>
    ...
    75d8:	79 f0       	breq	.+30     	; 0x75f8 <_mywait_sleeploop228+0x170>
    75da:	39 30       	cpi	r19, 0x09	; 9
        dataPtr = &usbConfiguration;  /* send current configuration value */
        len = 1;
    SWITCH_CASE(USBRQ_SET_CONFIGURATION)    /* 9 */
    75dc:	31 f4       	brne	.+12     	; 0x75ea <_mywait_sleeploop228+0x162>
...
{
usbMsgLen_t len = 0;
    75e8:	0a c0       	rjmp	.+20     	; 0x75fe <_mywait_sleeploop228+0x176>
    ...
    75ee:	09 f0       	breq	.+2      	; 0x75f2 <_mywait_sleeploop228+0x16a>
...
uchar   *dataPtr = usbTxBuf + 9;    /* there are 2 bytes free space at the end of the buffer */
    ...
    75f6:	03 c0       	rjmp	.+6      	; 0x75fe <_mywait_sleeploop228+0x176>
    ...
    7608:	31 f4       	brne	.+12     	; 0x7616 <_mywait_sleeploop228+0x18e>
    ...
    7614:	07 c0       	rjmp	.+14     	; 0x7624 <_mywait_sleeploop228+0x19c>
    ...
    761a:	04 c0       	rjmp	.+8      	; 0x7624 <_mywait_sleeploop228+0x19c>
    761c:	8e 81       	ldd	r24, Y+6	; 0x06
    761e:	82 17       	cp	r24, r18
    7620:	08 f4       	brcc	.+2      	; 0x7624 <_mywait_sleeploop228+0x19c>
    ...
    7624:	20 93 00 01 	sts	0x0100, r18
        ...
        usbMsgLen = replyLen;
    7628:	7e c0       	rjmp	.+252    	; 0x7726 <_mywait_sleeploop228+0x29e>
    762a:	90 91 12 01 	lds	r25, 0x0112
    }else{  /* usbRxToken must be USBPID_OUT, which means data phase of setup (control-out) */
#if USB_CFG_IMPLEMENT_FN_WRITE
        if(usbMsgFlags & USB_FLG_USE_USER_RW){
    762e:	97 ff       	sbrs	r25, 7
    7630:	7a c0       	rjmp	.+244    	; 0x7726 <_mywait_sleeploop228+0x29e>
...
uchar   i,isLast;
    ...
    763a:	08 f4       	brcc	.+2      	; 0x763e <_mywait_sleeploop228+0x1b6>
    ...
    7650:	08 f0       	brcs	.+2      	; 0x7654 <_mywait_sleeploop228+0x1cc>
    7652:	66 c0       	rjmp	.+204    	; 0x7720 <_mywait_sleeploop228+0x298>
    ...
    7662:	78 f0       	brcs	.+30     	; 0x7682 <_mywait_sleeploop228+0x1fa>
	...
	i++;
    7680:	e6 cf       	rjmp	.-52     	; 0x764e <_mywait_sleeploop228+0x1c6>
        len = bytesRemaining;
    bytesRemaining -= len;
    isLast = bytesRemaining == 0;
    for(i = 0; i < len;) {
    ...
    7686:	08 f0       	brcs	.+2      	; 0x768a <_mywait_sleeploop228+0x202>
    7688:	4c c0       	rjmp	.+152    	; 0x7722 <_mywait_sleeploop228+0x29a>
    768a:	f3 94       	inc	r15
    768c:	f3 94       	inc	r15
	  return 1;
	}
    ...
    76c2:	59 f0       	breq	.+22     	; 0x76da <_mywait_sleeploop228+0x252>
    76c4:	dd 20       	and	r13, r13
    76c6:	09 f4       	brne	.+2      	; 0x76ca <_mywait_sleeploop228+0x242>
    76c8:	c2 cf       	rjmp	.-124    	; 0x764e <_mywait_sleeploop228+0x1c6>
    76ca:	fe 14       	cp	r15, r14
    76cc:	08 f4       	brcc	.+2      	; 0x76d0 <_mywait_sleeploop228+0x248>
    76ce:	bf cf       	rjmp	.-130    	; 0x764e <_mywait_sleeploop228+0x1c6>
    76d0:	80 91 0d 01 	lds	r24, 0x010D
    76d4:	88 23       	and	r24, r24
    76d6:	09 f4       	brne	.+2      	; 0x76da <_mywait_sleeploop228+0x252>
    76d8:	ba cf       	rjmp	.-140    	; 0x764e <_mywait_sleeploop228+0x1c6>
    76da:	f8 94       	cli
...
#   ifndef NO_FLASH_WRITE
    ...
    76f4:	fd cf       	rjmp	.-6      	; 0x76f0 <_mywait_sleeploop228+0x268>
    76f6:	f8 94       	cli
...
#   endif
    ...
    770e:	00 fc       	sbrc	r0, 0
	    boot_spm_busy_wait();
    7710:	fd cf       	rjmp	.-6      	; 0x770c <_mywait_sleeploop228+0x284>
    7712:	f8 94       	cli
    ...
    771a:	e8 95       	spm
    771c:	78 94       	sei
    771e:	97 cf       	rjmp	.-210    	; 0x764e <_mywait_sleeploop228+0x1c6>
    ...
    7730:	6c c0       	rjmp	.+216    	; 0x780a <_mywait_sleeploop228+0x382>
    7732:	80 91 00 01 	lds	r24, 0x0100
        if(usbMsgLen != USB_NO_MSG){    /* transmit data pending? */
    7736:	8f 3f       	cpi	r24, 0xFF	; 255
    7738:	09 f4       	brne	.+2      	; 0x773c <_mywait_sleeploop228+0x2b4>
    773a:	67 c0       	rjmp	.+206    	; 0x780a <_mywait_sleeploop228+0x382>
    773c:	f8 2e       	mov	r15, r24
    773e:	89 30       	cpi	r24, 0x09	; 9
    7740:	10 f0       	brcs	.+4      	; 0x7746 <_mywait_sleeploop228+0x2be>
...
uchar       len;
    ...
    775a:	09 f4       	brne	.+2      	; 0x775e <_mywait_sleeploop228+0x2d6>
...
static uchar usbDeviceRead(uchar *data, uchar len)
{
    ...
    775c:	49 c0       	rjmp	.+146    	; 0x77f0 <_mywait_sleeploop228+0x368>
    775e:	80 91 12 01 	lds	r24, 0x0112
#if USB_CFG_IMPLEMENT_FN_READ
        if(usbMsgFlags & USB_FLG_USE_USER_RW){
    7762:	87 ff       	sbrs	r24, 7
    7764:	27 c0       	rjmp	.+78     	; 0x77b4 <_mywait_sleeploop228+0x32c>
...
uchar   i;
    ...
    776c:	08 f4       	brcc	.+2      	; 0x7770 <_mywait_sleeploop228+0x2e8>
    ...
    7788:	98 f5       	brcc	.+102    	; 0x77f0 <_mywait_sleeploop228+0x368>
uchar   i;
    ...
    77b2:	e5 cf       	rjmp	.-54     	; 0x777e <_mywait_sleeploop228+0x2f6>
    ...
    77be:	0b c0       	rjmp	.+22     	; 0x77d6 <_mywait_sleeploop228+0x34e>
    ...
    77d2:	f9 cf       	rjmp	.-14     	; 0x77c6 <_mywait_sleeploop228+0x33e>
    77d4:	09 c0       	rjmp	.+18     	; 0x77e8 <_mywait_sleeploop228+0x360>
                }while(--i);
    ...
    77e6:	fa cf       	rjmp	.-12     	; 0x77dc <_mywait_sleeploop228+0x354>
    ...
    77fe:	19 f0       	breq	.+6      	; 0x7806 <_mywait_sleeploop228+0x37e>
    ...
    usbTxLen = len;
    780e:	94 78       	andi	r25, 0x84	; 132
    7810:	31 f4       	brne	.+12     	; 0x781e <_mywait_sleeploop228+0x396>
        }else
#endif
        {
            uchar i = len;
    ...
    7814:	d9 f7       	brne	.-10     	; 0x780c <_mywait_sleeploop228+0x384>
    ...
    7824:	30 f0       	brcs	.+12     	; 0x7832 <_mywait_sleeploop228+0x3aa>
  : [sil]        "+d" (stayinloader)
  : [pin]         "I" (_SFR_IO_ADDR(PIN_PIN(JUMPER_PORT))),
    ...
    7826:	4e 9b       	sbis	0x09, 6	; 9
    7828:	0f c0       	rjmp	.+30     	; 0x7848 <_mywait_sleeploop228+0x3c0>
    782a:	80 91 11 01 	lds	r24, 0x0111
	  if (!bootLoaderConditionSimple()) {
    782e:	80 51       	subi	r24, 0x10	; 16
    7830:	09 c0       	rjmp	.+18     	; 0x7844 <_mywait_sleeploop228+0x3bc>
	    stayinloader-=0x10;
    7832:	4e 99       	sbic	0x09, 6	; 9
    7834:	09 c0       	rjmp	.+18     	; 0x7848 <_mywait_sleeploop228+0x3c0>
    7836:	80 91 11 01 	lds	r24, 0x0111
	  } 
	} else {
	  if (bootLoaderConditionSimple()) {
    783a:	82 30       	cpi	r24, 0x02	; 2
    783c:	28 f0       	brcs	.+10     	; 0x7848 <_mywait_sleeploop228+0x3c0>
    ...
    784e:	22 ce       	rjmp	.-956    	; 0x7494 <_mywait_sleeploop228+0xc>
#endif
#endif
#endif
